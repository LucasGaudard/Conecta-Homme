...
import { PackagePhotoLink } from "@/components/packages/package-photo-link";
            ...
            <dl className="mobile-field-grid">
              ...
              <div className="mobile-field">
                ...
                <dd className="mobile-field-value">
                  <PackagePhotoLink photoUrl={item.photoUrl} />
                </dd>
              </div>
              <div className="mobile-field">
        ...
        <table className="data-table min-w-[1280px]">
          <thead>
            <tr>
              ...
              {canManageDelivery ? <th className="px-4 py-3 font-medium">Ação</th> : null}
            </tr>
          </thead>
          <tbody>
            {visiblePackages.map((item) => (
